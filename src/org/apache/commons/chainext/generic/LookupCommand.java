...
import org.apache.commons.chainext.CatalogFactory;
...
import org.apache.commons.chainext.impl.MessageFactory;
...
public class LookupCommand implements Filter {
     ...
     * <code>MessageFactory.SUCCESS</code> if no command is found or if the command
     * is found but the <code>ignoreExecuteResult</code> property of this
     * instance is <code>MessageFactory.SUCCESS</code>
    ...
    public Message execute(Context context) throws Exception {
        ...
        if (command != null) {
            Message result = (command.execute(context));
