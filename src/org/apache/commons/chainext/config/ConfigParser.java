...
public class ConfigParser {
    ...
    /**
	 * <p>Parse the XML document at the specified path  using the configured
	 * <code>RuleSet</code>, registering catalogs with nested chains and
	 * commands as they are encountered. 
	 *  
     *
    * @param path <code>path</code> 可以是一个文件或一个目录，当为目录时将加载其下所有的.xml文件<br>
     * <blockquote>
     *  exampl path :
     *  <ul>
     *  	<li>"" :proejct root</li>
    ...
    public void parse(String path)throws Exception {
    	...
    	if(url==null){ throw new FileNotFoundException("invalide path:"+path);}
