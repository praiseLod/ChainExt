...
import org.apache.commons.chainext.Chain;
import org.apache.commons.chainext.Command;
import org.apache.commons.chainext.Context;
import org.apache.commons.chainext.Filter;
...
public class ChainBase implements Chain {
     ...
     *  is <code>null</code>
     *
     * @return <code>MessageFactory.SUCCESS</code> if the processing of this {@link Context}
     *  has been completed, or <code>MessageFactory.SUCCESS</code> if the processing
     *  of this {@link Context} should be delegated to a subsequent
     *  {@link Command} in an enclosing {@link Chain},otherwise <code>MessageFactory.ERROR</code>
     */
    public Message execute(Context context) throws Exception {
        ...
        for (i = 0; i < n; i++) {
            try {
            	message = commands[i].execute(context);
                if (message.isError()) {
                    break;
                }
            } catch (Exception e) {
